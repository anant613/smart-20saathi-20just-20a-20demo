    ...
    <header className="sticky top-0 z-50 w-full backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-lg sm:text-xl font-extrabold tracking-tight">Smart Saathi</span>
        </Link>
        <nav className="hidden md:flex items-center gap-1">
          <NavLink to="/about" className={navItem}>About</NavLink>
          <NavLink to="/contact" className={navItem}>Contact</NavLink>
          <NavLink to="/faq" className={navItem}>FAQ</NavLink>
          <NavLink to="/privacy" className={navItem}>Privacy</NavLink>
        </nav>
